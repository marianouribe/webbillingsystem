...
class NavBar extends Component {
  ...
  render() {
    return (
      <div className = "l-nav">
        <nav className="navbar navbar-light bg-faded navbar-custon">
          <button id="btn-toggle" className="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" 
